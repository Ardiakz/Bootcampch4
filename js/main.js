...
const buttonRpsUser = document.querySelectorAll('#user .choice');
const buttonRpsComp = document.querySelectorAll('#computer .choice');
const resetBtn = document.getElementById('reset-btn');

buttonRpsUser.forEach(function(el) {
    el.addEventListener('click', function() {
        buttonRpsUser.forEach(function(ele) {
        ...
        rps.computerTurn(buttonRpsComp);
    });
});
...
resetBtn.addEventListener('click', function(){
    ...
    buttonRpsComp.forEach(function(el){
        el.classList.remove('active');
    });
